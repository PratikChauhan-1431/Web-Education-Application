    ...
    <div class="container"><br><br>
					...
					<div class="progress-table">
						<div class="table-head">
							<div class="percentage">University Name</div>
							<div class="visit">Courses</div>
							<div class="visit">Place</div>
							<div class="visit">Contact</div>
						</div>
						
						<?php
						$query="Select * from institute where degree='$c' && place='$p'";
						...
						echo"
						<div class='table-row'>
							<div class='percentage'>".$row1["name"]."</div>
							<div class='visit'>".$row1["degree"]."</div>
							<div class='visit'>".$row1["place"]."</div>
							<div class='visit'>".$row1["contact"]."</div>
						</div>";
						}
